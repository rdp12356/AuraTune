  ...
  return (
    <div className="min-h-screen gradient-mesh flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5" aria-label={mode === 'signup' ? 'Sign up form' : mode === 'forgot' ? 'Password reset form' : 'Sign in form'}>
          <AnimatePresence mode="popLayout">
            {mode === 'signup' && (
              <motion.div
                ...
                className="relative"
              >
                <UserIcon size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground" aria-hidden="true" />
                <input
                  type="text"
          ...
          {mode !== 'forgot' && (
            <div className="relative">
              <Lock size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground" aria-hidden="true" />
              <input
                type="password"
          ...
          <motion.button
            ...
            aria-label={mode === 'signup' ? 'Create account' : mode === 'forgot' ? 'Send reset link' : 'Sign in'}
          >
