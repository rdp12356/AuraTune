...
export default function AuthScreen() {
  ...
  const { user, signIn, signUp, signInWithGoogle, resendSignUpEmail } = useAuth();
  ...
  const handleResend = async () => {
    ...
    toast.success('Verification email resent. Please check inbox and spam.');
  };
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground mt-2 text-sm">
            {isSignUp ? 'Create your account to sync progress' : 'Welcome back — continue your journey'}
          </p>
        </div>
