...
function AnimatedNumber({ value, duration = 1.5 }: { value: number; duration?: number }) {
  ...
  useEffect(() => {
    ...
    // display is intentionally excluded - animation should only restart when value/duration changes,
    // not on every render when display updates. This prevents animation stutter.
  }, [value, duration]);
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 0 && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 w-full max-w-sm mb-6">
              {QUICK_PRESETS.map(p => (
                <motion.button key={p.label} whileTap={{ scale: 0.95 }} onTap={() => {
            ...
            {canProceedFromStep0 && (
              <motion.button whileTap={{ scale: 0.95 }} onTap={nextStep}
        ...
        {step === 5 && (
          ...
          >
            ...
            <motion.button whileTap={{ scale: 0.95 }} onTap={complete}
